...
if __name__ == '__main__':
    ...
    Process(target=parse_to_array, args=(text_conn_b, metars_conn_a))
    Process(target=extract_wind_direction, args=(metars_conn_b, winds_conn_a))
    Process(target=mine_wind_distribution, args=(winds_conn_b, winds_dist_conn_a))
